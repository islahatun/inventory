					...
					<table class="table table-responsive-sm" id="dt">
						<thead>
							<tr>
								...
								<th scope="col" class="text-center">Kode Satuan</th>
								<th scope="col" class="text-center">Descripsi</th>
							</tr>
						</thead>
						<tbody>
						</tbody>
						...
						<div class="modal-content">
							...
							<form id="fm" action="" enctype="multipart/form-data" method="post">
								<div class="modal-body">
									<input type="hidden" name="id_satuan" id="">
									<div class="mb-3 row">
										<label for="nama_satuan" class="col-sm-4 col-form-label">Kode Satuan</label>
										<div class="col-sm-8">
											<input required type="text" class="form-control" id="nama_satuan" name="nama_satuan">
										</div>
									</div>
									<div class="mb-3 row">
										<label for="descripsi" class="col-sm-4 col-form-label">Descripsi</label>
										<div class="col-sm-8">
											<input required type="text" class="form-control" id="descripsi" name="descripsi">
										</div>
									</div>
								</div>
